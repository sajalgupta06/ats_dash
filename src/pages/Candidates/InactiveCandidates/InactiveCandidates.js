...
import'../AllCandidates/AllCandidates.scss';
...
export default function InactiveCandidates({setIsCandidateDetail,setCandidateDetail,setAdvencedSearch}) {
...
useEffect(() => {
  ...
  try {
    const response = await axios({
      // url: `http://localhost:8000/api/dash/app/users?page=${page}&limit=${6}userStatus=1`,
      url: `https://job-market-node.codedeployment.tk/api/dash/app/users?page=${page}&limit=${6}&userStatus=1`,
      method: "GET",
