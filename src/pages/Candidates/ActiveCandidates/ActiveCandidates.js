...
export default function ActiveCandidates({setIsCandidateDetail,setCandidateDetail,setAdvencedSearch}) {
...
useEffect(() => {
  ...
  try {
    const response = await axios({
      ...
      url: `https://job-market-node.codedeployment.tk/api/dash/app/users?page=${page}&limit=${6}&userStatus=0`,
      method: "GET",
