...
<h3 style={{color:"#515151" ,position:"relative",top:"3rem"}} >Pay Slip(january)</h3>
        ...
        <div className="pdf-bottom">
            <div className="pdf-bottom-left">
                <img src={pdf}></img>
            <p style={{marginLeft:"1rem"}}>Salary Slip

            <br></br>
            <p style={{fontSize:"1rem "}}>PDF-5MB</p>
            </p>
            </div>
        <img src={download} style={{height:"2rem",marginTop:"1rem"}} ></img>
        </div>
